...
public class DiyController {
    ...
    public String showEditRecipeForm(@PathVariable Long id, HttpSession session,
            Model model, RedirectAttributes redirectAttributes) {

        String username = (String) session.getAttribute("loggedInUser");

        try {
            Recipe recipe = diyService.getDiyRecipeForEdit(id, username);
    ...
    public String updateRecipe(
        ...
        try {
            diyService.updateDiyRecipe(id, updateRecipe, username, imageFile);
