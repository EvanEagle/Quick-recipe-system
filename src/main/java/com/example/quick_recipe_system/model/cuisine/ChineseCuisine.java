    ...
    public ChineseCuisine() {
        ...
        this.addRecipe(new Recipe(1, "番茄炒蛋", 15,
                ...
                List.of("將雞蛋加鹽巴調味並打散",
                        ...
                        "將番茄悶至熟軟熟透",
                        "將蛋加入炒拌至入味並撒上蔥花即可上桌"),
                List.of("中式", "蛋料理", "家常菜", "下飯", "簡單"),
                "https://www.youtube.com/embed/frFPrY8upmw"));
        // 2.
        this.addRecipe(new Recipe(2, "麻婆豆腐", 15,
                ...
                List.of("豆腐", "中式", "家常菜", "下飯", "簡單"),
                "https://www.youtube.com/embed/PnCWCnozwvc"));
        // 3.
        this.addRecipe(new Recipe(3, "紅燒豆腐", 10,
                ...
                List.of("素食", "簡單快速", "家常菜", "豆腐"),
                "https://www.youtube.com/embed/n4W022W8d3c"));
        // 4.
        this.addRecipe(new Recipe(4, "洋蔥煎肉餅", 10,
                ...
                List.of("豬絞肉放入鋼盆中，加入鹽攪拌至有黏性",
                        ...
                        "煎熟後取出盛盤，沾番茄醬食用即可"),
                List.of("早餐", "點心", "簡單快速", "豬肉"),
                "https://www.youtube.com/embed/bI70ShwVtEk"));
        // 5.
        this.addRecipe(new Recipe(5, "香蔥煎蛋", 8,
                ...
                List.of("蔥去頭，切成細蔥花",
                        ...
                        "翻面煎，定型後再晃動煎１分鐘煎熟即可"),
                List.of("家常菜", "蛋料理", "簡單快速"),
                "https://www.youtube.com/embed/oAg53uI8yJc"));
    }
